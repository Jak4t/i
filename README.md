...
local PepsiUi = library:CreateWindow({Name = "Script BloxFruit",Theme = {Image = "rbxassetid://7483871523",Info = "Info",Background = {Asset = "rbxassetid://5553946656"}}})local KaiTun = PepsiUi:CreateTab({Name = "Genaral"})local KaiTun2 = KaiTun:CreateSection({Name = "Main",Side = "Left"})KaiTun2:AddToggle({Name="Start Farm Kaitun",Value=false,Callback=function(value)getgenv().LevelFarm=value;StopBodyClip(getgenv().LevelFarm);end})local KaiTun2 = KaiTun:CreateSection({Name = "Stars Farm",Side = "Left"})local KaiTun2 = KaiTun:CreateSection({Name = "Main KaiTun",Side = "Left"})local KaiTun3 = KaiTun:CreateSection({Name = "Main KaiTun",Side = "Right"})local KaiTun6 = KaiTun:CreateSection({Name = "Sword",Side = "Right"})local KaiTun5 = KaiTun:CreateSection({Name = "Melee",Side = "Left"})QuestAR = KaiTun:CreateSection({Name = "Quest",Side = "Left"})Gun = KaiTun:CreateSection({Name = "Gun",Side = "Rght"})LevelFarmFarm=KaiTun2:AddLabel({Name = "AutoFarm : âŒ"})StastConFig=KaiTun2:AddLabel({Name = "UesConFig : âœ…"})KaiTun2:AddLabel({Name = "Super Fast : âœ…"})KaiTun2:AddLabel({Name = "Bypass : âœ…"})WolrdSet3=KaiTun2:AddLabel({Name = "Wolrd : 1 âŒ"})WolrdSet=KaiTun2:AddLabel({Name = "Wolrd : 2 âŒ"})WolrdSet1=KaiTun2:AddLabel({Name = "Wolrd : 3 âŒ"})StastMelee=KaiTun2:AddLabel({Name = ""})StastDefense=KaiTun2:AddLabel({Name = ""})StastSword=KaiTun2:AddLabel({Name = ""})StastGun=KaiTun2:AddLabel({Name = ""})StastDevilFruit=KaiTun2:AddLabel({Name = ""})PointsStast=KaiTun2:AddLabel({Name = ""})PlayerName=KaiTun3:AddLabel({Name = ""})Health=KaiTun3:AddLabel({Name = ""})Energy=KaiTun3:AddLabel({Name = ""})BountyHonorStast=KaiTun3:AddLabel({Name = ""})LevelStast=KaiTun3:AddLabel({Name = ""})EXP=KaiTun3:AddLabel({Name = ""})FragmentsStast=KaiTun3:AddLabel({Name = ""})BeliStast=KaiTun3:AddLabel({Name = ""})DevilFruitStast=KaiTun3:AddLabel({Name = ""})RaceStast=KaiTun3:AddLabel({Name = ""})Superhuman = KaiTun5:AddLabel({Name = "âŒ : Superhuman"})DeathStep = KaiTun5:AddLabel({Name = "âŒ : Death Step"})SharkmanKarate = KaiTun5:AddLabel({Name = "âŒ : Sharkman Karate"})ElectricClaw = KaiTun5:AddLabel({Name = "âŒ : Electric Claw"})DragonTalon = KaiTun5:AddLabel({Name = "âŒ : Dragon Talon"})GodHuman = KaiTun5:AddLabel({Name = "âŒ : God Human"})Shisui = KaiTun6:AddLabel({Name = "âŒ : Shisui"})Saddi = KaiTun6:AddLabel({Name = "âŒ : Saddi"})Wando = KaiTun6:AddLabel({Name = "âŒ : Wando"})TrueTripleKatana = KaiTun6:AddLabel({Name = "âŒ : True Triple Katana"})Saber = KaiTun6:AddLabel({Name = "âŒ : Saber"})Rengoku = KaiTun6:AddLabel({Name = "âŒ : Rengoku"})MidnightBlade = KaiTun6:AddLabel({Name = "âŒ : Midnight Blade"})DragonTrident = KaiTun6:AddLabel({Name = "âŒ : DragonTrident"})Yama = KaiTun6:AddLabel({Name = "âŒ : Yama"})BuddySword = KaiTun6:AddLabel({Name = "âŒ : Buddy Sword"})Canvander = KaiTun6:AddLabel({Name = "âŒ : Canvander"})TwinHooks = KaiTun6:AddLabel({Name = "âŒ : Twin Hooks"})SpikeyTrident = KaiTun6:AddLabel({Name = "âŒ : Spikey Trident"})HallowScythe = KaiTun6:AddLabel({Name = "âŒ : Hallow Scythe"})DarkDagger = KaiTun6:AddLabel({Name = "âŒ : Dark Dagger"})Tushita = KaiTun6:AddLabel({Name = "âŒ : Tushita"})Kabucha = Gun:AddLabel({Name = "âŒ : Kabucha"})AcidumRifle = Gun:AddLabel({Name = "âŒ : Acidum Rifle"})BizarreRifle = Gun:AddLabel({Name = "âŒ : Bizarre Rifle"})BartiloQuest = QuestAR:AddLabel({Name = "âŒ : Bartilo Quest"})DonSwanQuest = QuestAR:AddLabel({Name = "âŒ : Don Swan Quest"})KillDonSwan = QuestAR:AddLabel({Name = "âŒ : Kill Don Swan"})
------------BodyClip and NoClip
...
task.spawn(function() pcall(function()  while wait() do if game.PlaceId == 2753915549 then WolrdSet3:Set("Wolrd : 1 ".."âœ…") end end end) end)
task.spawn(function() pcall(function() while wait() do if game.PlaceId == 4442272183 then WolrdSet:Set("Wolrd : 2 ".."âœ…") end end end) end)
task.spawn(function() pcall(function() while wait() do if game.PlaceId == 7449423635 then WolrdSet1:Set("Wolrd : 3 ".."âœ…") end end end) end)
...
task.spawn(function() pcall(function()  while wait() do if getgenv().LevelFarm==false then LevelFarmFarm:Set("AutoFarm : âŒ") elseif getgenv().LevelFarm==true then LevelFarmFarm:Set("AutoFarm : âœ…") end end end) end)
task.spawn(function() while task.wait() do pcall(function() for i,v in pairs(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventoryWeapons")) do if v.Name == "Saber" then Saber:Set("âœ… : Saber") end if v.Name == "Rengoku" then Rengoku:Set("âœ… : Rengoku") end if v.Name == "Midnight Blade" then MidnightBlade:Set("âœ… : Midnight Blade") end if v.Name == "Dragon Trident" then  DragonTrident:Set("âœ… : Dragon Trident") end if v.Name == "Yama" then Yama:Set("âœ… : Yama") end if v.Name == "Buddy Sword" then BuddySword:Set("âœ… : Buddy Sword") end if v.Name == "Canvander" then Canvander:Set("âœ… : Canvander") end if v.Name == "Twin Hooks" then TwinHooks:Set("âœ… : Twin Hooks") end if v.Name == "Spikey Trident" then SpikeyTrident:Set("âœ… : Spikey Trident") end if v.Name == "Hallow Scythe" then  HallowScythe:Set("âœ… : Hallow Scythe") end if v.Name == "Dark Dagger" then DarkDagger:Set("âœ… : Dark Dagger") end if v.Name == "Tushita" then  Tushita:Set("âœ… : Tushita") end end end) end end)
---------------- Gun Check ----------------
task.spawn(function()while task.wait() do pcall(function() for i,v in pairs(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventoryWeapons")) do if v.Name == "Kabucha" then Kabucha:Set("âœ… : Kabucha") end if v.Name == "Acidum Rifle" then AcidumRifle:Set("âœ… : Acidum Rifle") end if v.Name == "Bizarre Rifle" then BizarreRifle:Set("âœ… : Bizarre Rifle") end end end) end end)
---------------- Quest Check ----------------
task.spawn(function()while task.wait() do if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress","Bartilo") == 3 then  BartiloQuest:Set("âœ… : Bartilo Quest") end if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetUnlockables").FlamingoAccess == nil then else DonSwanQuest:Set("âœ… : Don Swan Quest") end if game:GetService("ReplicatedStorage").Remotes["CommF_"]:InvokeServer("ZQuestProgress", "Check") == 1 then KillDonSwan:Set("âœ… : Kill Don Swan") end end end)
---------------- Legendary Sword Check ----------------
task.spawn(function()while task.wait() do pcall(function() for i,v in pairs(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("getInventoryWeapons")) do if v.Name == "Shisui" then Shisui:Set("âœ… : Shisui") end if v.Name == "Saddi" then Saddi:Set("âœ… : Saddi") end if v.Name == "Wando" then Wando:Set("âœ… : Wando") end if v.Name == "True Triple Katana" then TrueTripleKatana:Set("âœ… : True Triple Katana") end end end) end end)
---------------- Melee Check ----------------
task.spawn(function()while task.wait() do if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman",true) == 1 then Superhuman:Set("âœ… : Superhuman") end if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep",true) == 1 then DeathStep:Set("âœ… : Death Step") end if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate",true) == 1 then SharkmanKarate:Set("âœ… : Sharkman Karate") end if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw",true) == 1 then ElectricClaw:Set("âœ… : Electric Claw") end if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon",true) == 1 then DragonTalon:Set("âœ… : Dragon Talon") end if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodHuman",true) == 1 then GodHuman:Set("âœ… : God Human") end end end)
...
function QuestCheck() 
    ...
    if OldWolrd then
        ...
        --[[elseif MyLevel == 275 or MyLevel <= 299 then ----à¸¡à¸­à¸™à¹„à¸¡à¹ˆà¹€à¸à¸´à¸”
...
return library, library_flags, library.subs----à¸­à¸¢à¹ˆà¸²à¹€à¸­à¸²à¸­à¸­à¸à¹„à¸­à¸ªà¸±à¸ª
